...
const B2BConfig = {
    ...
    // YENİ: Bakım modunu kapatma metodu
    disableMaintenanceMode: function() {
        this.system.maintenance = false;
        this.system.maintenanceMessage = "";
        this.saveToStorage();
        this.triggerConfigChange();
        console.log('✅ Bakım modu kapatıldı');
    },

    // YENİ: Hızlı bakım modu kontrolü
    checkMaintenanceMode: function() {
        if (this.system.maintenance) {
            console.warn('🚧 BAKIM MODU AKTİF!', this.system.maintenanceMessage);
            return true;
        }
        return false;
    },
